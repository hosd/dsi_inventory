            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                ...
                <div style="width: 50%; float: left;">
                    <div class="col-md-6" style="float: left;">
                        <p style="margin-bottom: 2px; margin-top: 2px;">Ref no</p>
                        <p style="margin-bottom: 2px; margin-top: 2px;">යොමු අංකය</p>
                        <p style="margin-bottom: 2px; margin-top: 2px;">குறிப்பு இல</p>
                ...
                <div style="width: 50%; float: left;">
                    <div class="col-md-6" style="float: left;">
                        <p style="margin-bottom: 2px; margin-top: 2px;">Date</p>
                        <p style="margin-bottom: 2px; margin-top: 2px;">දිනය</p>
                        <p style="margin-bottom: 2px; margin-top: 2px;">தேதி</p>
                    </div>
