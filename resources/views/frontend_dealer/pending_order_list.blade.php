@section('title', 'Pending Pickup Orders')

<x-dealer-layout>
    <div style="background-color: black;">
        <h2 class="heading_text text-white ps-4">Pending Pickup Orders</h2>
    </div>
    @if ($errors->any())
                            ...
                            <table id="table_1" class="pending_orders_table table table-striped data-table" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Last Pickup Date</th>
...
<!--                                    <tr>
                                        ...
                                        <td>2</td>
                                        <td>G.H.K.Edirisinghe</td>
                                        <td>+941234567890</td>
                                        <td>5/28/23</td>
                                        <td><div class="dropdown">
                                            <button class="btn btn-secondary dropdown-toggle" type="button" id="pendingDropdown1" data-bs-toggle="dropdown" aria-expanded="false">
                                            Pending
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="pendingDropdown1">
            ...
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    headers: {
                        ...
                        url: "{{ route('dealer/pending-orders')}}",
