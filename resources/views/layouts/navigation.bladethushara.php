<nav x-data="{ open: false }" class="">
    ...
    <header id="header">
        <div id="logo-group">
            ...
            <span id="logo"> <img src="{{ asset('public/back/img/logo.png') }}" alt="Labour Managment System"> </span>
                ...
                <span>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-dropdown-link :href="route('logout')" onclick="event.preventDefault();
                                                this.closest('form').submit();"  style="padding: 6px 7px; margin-top: 10px; border: 1px solid #bfbfbf; background-color: #f8f8f8; font-size: 16px;">
    ...
    -->
            ...
            <ul>
                ...
                <li >
                    <a href="#"><i class="fa fa-lg fa-fw fa-puzzle-piece"></i> <span class="menu-item-parent">{{ $item->title }}</span></a>
