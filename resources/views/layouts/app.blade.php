	...
	<style>
		.parsley-errors-list li{
            ...
            aside {
                ...
                color: #fff;
               /* background-image: url('https://developments.tekgeeks.net/dsi_inventory/images/menu_bg.jpg') !important;*/
                background-image: url('{{ asset('images/menu_bg.jpg') }}')!important; 
	...
	<div class="page-footer">
		<div class="row">
			<div class="col-xs-12 col-sm-6">
                ...
                <span class="txt-color-white">© {{now()->year}}  |  <small>Solution by - <a href="https://www.tekgeeks.net/" target="_blank" style="color: #999999;">TekGeeks</a></small></span>
