            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-region') }}">
                            <button class="btn cms_top_btn top_btn_height ">ADD NEW REGION</button>
                        </a>

                        <a href="{{ route('region-list') }}">
                            <button class="btn cms_top_btn top_btn_height @if(Request::segment(1) == 'region-list')cms_top_btn_active @endif">VIEW ALL REGION</button>
                        </a>
                    </div>
                </div>
            </div>
