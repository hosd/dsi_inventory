            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-region') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">ADD NEW REGION</button>
                        </a>

                        <a href="{{ route('region-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">VIEW ALL REGION</button>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-region') }}" enctype="multipart/form-data" method="post" id="store_details_form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row ">

                                    <section class="col col-6">
                                        <label class="label">Region Name <span style=" color: red;">*</span></label>
