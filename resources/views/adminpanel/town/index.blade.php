...
$name = $info[0]->city_name_en;
$status = $info[0]->status; 
$provinceID = $info[0]->province_id;
$districtID = $info[0]->district_id;
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-town') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">ADD NEW TOWN</button>
                        </a>

                        <a href="{{ route('town-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">VIEW ALL TOWN</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-town') }}" enctype="multipart/form-data" method="post" id="store_details_form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row ">
                                ...
                                <div class="row ">
                                    <section class="col col-6">
                                        <label class="label">Town Name <span style=" color: red;">*</span></label>
                            ...
                            <footer>
                                ...
                                <a class="btn btn-default" href="{{route('town-list')}}"> Back</a>
                            </footer>
                        </form>
                    </div>
                    <!-- end widget content -->
...
//            });
                ...
                $('#store_details_form').validate({
                    ...
                    messages: {
                        ...
                        districtID: {
                            required: "Please the a territory",
                        },
                        name: {
            ...
            $(document).on('change', '#provinceID', function (e) {
                ...
                $.ajax({
                    url: "{{ route('get-region-territories') }}",
                    type: 'get',
                    dataType: 'json',
                    data: {
                        provinceID: id
