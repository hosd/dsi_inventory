            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-town') }}">
                            <button class="btn cms_top_btn top_btn_height ">ADD NEW TOWN</button>
                        </a>

                        <a href="{{ route('town-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">VIEW ALL TOWNS</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
