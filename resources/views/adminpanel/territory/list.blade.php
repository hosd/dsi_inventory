            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-territory') }}">
                            <button class="btn cms_top_btn top_btn_height ">ADD NEW TERRITORY</button>
                        </a>

                        <a href="{{ route('territory-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">VIEW ALL TERRITORY</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
                                    ...
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr >
                                                ...
                                                <th width="15%">Edit</th>
                                                <th width="15%" align="center" >Activation</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
