            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-category') }}">
                            <button class="btn cms_top_btn top_btn_height ">ADD NEW CATEGORY</button>
                        </a>

                        <a href="{{ route('category-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">VIEW ALL CATEGORIES</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
