            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-model') }}">
                            <button class="btn cms_top_btn top_btn_height ">ADD NEW MODEL</button>
                        </a>

                        <a href="{{ route('model-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">VIEW ALL MODELS</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
                    <ul id="sparks" class="">
                        <ul id="sparks" class="">
                            ...
                            <li class="sparks-info sparks-info_active" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 22px 15px; min-width: auto;">
                                <a href="{{ route('login') }}">
                                    <h5>{{ __('complainmodel.view_all') }}</h5>
                                </a>
                            </li>
                        </ul>
                    </ul>
